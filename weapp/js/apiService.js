...
var host = 'https://nqobaxsg.cn/qq/';

function ApiService() {
  this.token = wx.getStorageSync('token');
}

ApiService.prototype = (_ApiService$prototype = {
    ...
    return new Promise(function (r, j) {
      wx.cloud.callFunction({
        ...
        fail: function fail(err) {
          j(err); // console.error(`[subDailyWeatherCloudFn] => Fail => ${err}`)
        }
      });
    })["catch"](function (e) {
  ...
  getTarotBigCardOrders: function getTarotBigCardOrders() {
    var self = this;
    return _ajax["default"].get({
  ...
  orderLock: function orderLock(order_id, card_nums) {
    var self = this;
    return _ajax["default"].post({
      url: host + '/orderLock',
      data: {
  ...
  getTarotsInfo: function getTarotsInfo(cards, withDetail, title) {
    var self = this,
        v = '1.0.3',
        h = v === '1.0.4' ? host_test : host;
    return _ajax["default"].post({
      url: h + '/getTarotsInfo',
      data: {
        token: this.token,
  ...
  getAuguryOrderByOrderId: function getAuguryOrderByOrderId(order_id, isNoUse) {
    var self = this;
    return _ajax["default"].post({
  ...
  getStarTopInfo: function getStarTopInfo() {
    var self = this;
    return _ajax["default"].get({
  ...
  orderUse: function orderUse(order_id, card_nums) {
    var self = this;
    return _ajax["default"].post({
      url: host + 'orderUse',
      data: {
  ...
  getProducts: function getProducts(isInWeixin) {
    var self = this;
    return _ajax["default"].get({
      url: host + 'products',
      data: {
  ...
  sharedWeixinWeb: function sharedWeixinWeb() {
  ...
  getSdkSign: function getSdkSign() {
    var self = this;
    return _ajax["default"].get({
      url: host + 'getSdkSign',
      data: {
...
}, _defineProperty(_ApiService$prototype, "put2Desktop", function put2Desktop() {
  var self = this;
  return _ajax["default"].post({
    url: host + 'put2Desktop',
    data: {
...
}), _defineProperty(_ApiService$prototype, "getArticleByName", function getArticleByName(name, key) {
  var self = this;
  return _ajax["default"].get({
...
}), _defineProperty(_ApiService$prototype, "wrapperError", function wrapperError(e, errorDefind) {
